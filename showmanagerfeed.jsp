...
<html>
    ...
    <body>
         ...
         <div style="display: flex; justify-content: space-around;margin-top: 520px;">
             <a href="managerpage.jsp"><img src="homeicon.png" class="functions"></a>
            <img src="owners.png" class="functions">
            <a href="showcustfeed.jsp"><img src="feedback.png" class="functionscurrent"></a>

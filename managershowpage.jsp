...
<%@page import="java.sql.DriverManager,java.sql.ResultSet,java.sql.PreparedStatement,java.sql.Connection,java.util.*" %>
            <%
                ...
                PreparedStatement st1 = con.prepareStatement("select * from product");
                ...
                <tr align="center">
                    <td><div class="box">
                        ...
                        <div style="display:flex; justify-content: space-around;">
                         ...
                         <br>
                         <br>
                          <button class="order" onclick="redirectToPayment(this)" data-product-id="<%= list5.get(i) %>">DELETE</button>
...
function redirectToPayment(button) {
  ...
  window.location.href = "mandelproduct.jsp?product_id=" + encodeURIComponent(productId);
}
</script> 

                ...
                <tr align="center">
                    <td><div class="box">
                        ...
                        <div style="display:flex; justify-content: space-around;">
                         ...
                         <br>
                         <br>
                         <button class="order" onclick="redirectToPayment(this)" data-product-id="<%= list5.get(i) %>">Order Now</button>
                        </div></td> 
                        <%i++; 
                        if(i>=list5.size())
                        {
...
function redirectToPayment(button) {
  ...
  window.location.href = "payment.jsp?product_id=" + encodeURIComponent(productId);
}
</script> 
